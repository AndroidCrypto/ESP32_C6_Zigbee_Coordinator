...
// uncomment just one device. For uploading Devices 1, 2 + 3 use
// 'Zigbee END DEVICE'
//#define IS_DEVICE_1 true
//#define IS_DEVICE_2 true
#define IS_DEVICE_3 true
...
#ifdef IS_DEVICE_1
char *PROGRAM_VERSION = "ESP32 C6 Zigbee Temperature Sensor LQI with OLED V02 Dev 1 End Device";
char *PROGRAM_VERSION_SHORT = "Zigbee Temp LQI Dev 1 V02";
// Zigbee temperature sensor configuration
#define TEMP_SENSOR_ENDPOINT_NUMBER 11
char *MANUFACTURER_NAME = "AndCrypt1";
char *MODEL_NAME = "Temp1";
//#define HAS_OLED_DISPLAY
#endif

#ifdef IS_DEVICE_2
char *PROGRAM_VERSION = "ESP32 C6 Zigbee Temperature Sensor LQI with OLED V02 Dev 2 End Device";
char *PROGRAM_VERSION_SHORT = "Zigbee Temp LQI Dev 2 V02";
// Zigbee temperature sensor configuration
#define TEMP_SENSOR_ENDPOINT_NUMBER 12
char *MANUFACTURER_NAME = "AndCrypt2";
char *MODEL_NAME = "Temp2";
#define HAS_OLED_DISPLAY
#endif

#ifdef IS_DEVICE_3
char *PROGRAM_VERSION = "ESP32 C6 Zigbee Temperature Sensor LQI with OLED V02 Dev 3 End Device";
char *PROGRAM_VERSION_SHORT = "Zigbee Temp LQI Dev 3 V02";
// Zigbee temperature sensor configuration
#define TEMP_SENSOR_ENDPOINT_NUMBER 13
char *MANUFACTURER_NAME = "AndCrypt3";
char *MODEL_NAME = "Temp3";
#define HAS_OLED_DISPLAY
#endif
...
static void temp_sensor_value_update() {
  ...
  oDisplay4 = buf;
  oDisplay5 = "Temp:" + String(tsens_value) + "C";
...
void setup() {
  ...
  Serial.println("This is an Endpoint that has NO Router capabilities");
