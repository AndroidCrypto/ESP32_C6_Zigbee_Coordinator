...
/*
  Version management
02.04.2026 V01 Initial programming, using the original Zigbee_On-Off_Switch example and
               added an OLED, using the Onboard RGB LED and uses the advanced Zigbee 
               Debug settings. The light state polling is reduced to a 2 seconds
               interval.
*/
...
char *PROGRAM_VERSION = "ESP32 C6 Zigbee On Off Switch example with OLED V01";
