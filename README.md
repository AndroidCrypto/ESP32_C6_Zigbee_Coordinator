...
- **How to use an ESP32-C6 as Zigbee Coordinator or End Device for a Thermometer or Thermostat**: [soon](https://medium.com/@androidcrypto/how-to-use-an-esp32-c6-as-zigbee-coordinator-or-end-device-for-a-thermometer-or-thermostat-b91fca418849)
