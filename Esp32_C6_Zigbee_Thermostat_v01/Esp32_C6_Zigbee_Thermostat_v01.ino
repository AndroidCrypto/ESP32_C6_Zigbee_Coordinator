/*
  Version Management
05.04.2026 V01 This is the original Zigbee_Thermostat sketch from Arduino Espressif ESP32 Boards version 3.3.7
...
Zigbee Mode ZCZR (coordinator/router)
*/

/*
Error condition:
With option Zigbee Mode ZCZR with Debug (coordinator/router) on an ESP32-C6 Super Mini (4 MB Flash)
Sketch uses 1342488 bytes (102%) of program storage space. Maximum is 1310720 bytes.
Global variables use 37872 bytes (11%) of dynamic memory, leaving 289808 bytes for local variables. Maximum is 327680 bytes.
