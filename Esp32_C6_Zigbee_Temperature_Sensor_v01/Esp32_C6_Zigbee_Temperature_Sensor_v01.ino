/*
  Version Management
05.04.2026 V01 This is the original Zigbee_Temperature_Sensor sketch from Arduino Espressif ESP32 Boards version 3.3.7
...
void setup() {
  ...
  zbTempSensor.setManufacturerAndModel("AndroidCrypto", "ZigbeeTempSensor");
